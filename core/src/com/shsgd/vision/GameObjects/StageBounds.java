...
import static com.shsgd.vision.Screens.PlayScreen.MAP_WIDTH;
import static com.shsgd.vision.Screens.PlayScreen.MAP_HEIGHT;
...
public class StageBounds {
    ...
    public StageBounds(World world, float x, float y){
        ...
        edgeShape.set(-MAP_WIDTH/2, -MAP_HEIGHT/2-2, MAP_WIDTH/2, -MAP_HEIGHT/2-2);
        ...
        edgeShape.set(MAP_WIDTH/2, -MAP_HEIGHT/2, MAP_WIDTH/2, MAP_HEIGHT/2);
